  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        table: "w-full border-collapse border border-gray-200 rounded-xl overflow-hidden",
        weekdays: cn("flex border-b-2 border-gray-200", defaultClassNames.weekdays),
        weekday: cn(
          "text-muted-foreground flex-1 select-none text-[0.85rem] font-semibold border-r border-gray-100 last:border-r-0 py-1",
        ...
        day: cn(
          "group/day relative aspect-square h-full w-full select-none p-0 text-center border-r border-gray-100 last:border-r-0 [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md",
